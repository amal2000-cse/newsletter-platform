    ...
    <div className="bg-[#f7f5ff] h-[95vh]">
      ...
      <div className="w-full h-full flex justify-center items-center relative overflow-hidden">
        ...
        <div className="absolute">
          <h1 className="font-clashDisplay uppercase font-bold text-cyber-ink text-[2.7rem] md:text-[7xl] lg:text-[4rem]  max-w-4xl mx-auto text-center z-10">
            THE NEWSLETTER PLATFORM BUILT FOR
            <span className="font-style">GROW</span>
          </h1>
          <br />

          <h3 className="text-2xl text-center font-clashDisplay">Build by newsletter people</h3>
          <br />
          ...
          <br />
          <h5 className="text-center font-clashDisplay text-lg">start a 30day free trial</h5>
        </div>
      </div>
    </div>
  );
